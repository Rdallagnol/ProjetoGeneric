                        ...
                        <li class="light-blue dropdown-modal">
                            ...
                            <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                                ...
                                <li>
                                    ...
                                    <?php echo $this->Html->link($this->Html->tag("i", "<span></span>",array("class" => "ace-icon fa fa-power-off")). ' Sair', array('controller' => 'users', 'action' => 'logout'),array('escape' => false)); ?>
                ...
                <div class="footer-inner">
                    <div class="footer-content">
                        <span class="bigger-120">
                            <span class="blue bolder">RWD</span>
                            Company &copy;
                        </span>
                        ...
                        <span class="action-buttons">
                            <a href="https://mail.google.com" target="_blank">
                                <i class="ace-icon fa fa-envelope-square light-red bigger-200"></i>
                            </a>
                        </span>
                    </div>
                </div>
